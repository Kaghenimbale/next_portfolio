      ...
      <div className="grid grid-cols-1 justify-items-center gap-4 lg:grid-cols-2">
        <div className="flex flex-col gap-5 bg-slate-100 rounded-lg p-4 sm:w-[25rem] shadow-xl shadow-slate-300">
          ...
          <p>
            ...
            smart, friendly, and hard worker with good communication skills. He
            is also a good collaborator and team player with both technical and
            professional skills. His problem-solving skill is on the next level.
            We build group projects in Microverse and he was a very effective
            teammate. I recommend him not because he is a good friend of mine,
            but for the amazing skills that he possesses."
          </p>
        ...
        <div className="flex flex-col gap-5 bg-slate-100 rounded-lg p-4 sm:w-[25rem] shadow-xl shadow-slate-300">
          ...
          <p>
            ...
            online school of global developers and that was one of the greatest
            weeks that I spent with my coding partner at Microverse. I learned
            many things from him. I can recommend this guy because he is just
            one of the greatest people I ever meet in my journey as a software
            developer.
          </p>
